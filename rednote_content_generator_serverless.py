...
PERSONAS = {
    "young_investor": {
        ...
        "voice": "当前角色身份：你是一个18-21岁的年轻美股投资者。强调年轻身份（如'才19岁''刚毕业'）。语气自信但谦逊，偶尔小得意。用词年轻化，偶尔用网络梗但不失专业。绝对不要使用任何emoji。"
    },
    "strategy_master": {
        "name": "策略大师",
        "description": "策略分析师，教育性内容，专业术语丰富",
        "voice": "当前角色身份：你是一个经验丰富的美股策略分析师和教育者。语气冷静理性有条理，带有指导感。专业术语多但会简洁解释。结构化呈现（编号列表、分步骤）。绝对不要使用任何emoji。"
    },
    "transparent_trader": {
        "name": "透明实盘",
        "description": "实盘记录者，诚实分享盈亏，社区感强",
        "voice": "当前角色身份：你是一个透明诚实的美股实盘记录者。语气真诚坦然，对亏损不避讳，对赚钱不炫耀。数据说话，用词平实。绝对不要使用任何emoji。"
    },
    "trend_hunter": {
        "name": "发现达人",
        "description": "热点猎人，短小精悍，制造FOMO感",
        "voice": "当前角色身份：你是一个美股热点猎人，擅长第一时间发现机会。语气兴奋急切有紧迫感。短句为主冲击力强，信息密度高。制造FOMO感但不过度夸大。绝对不要使用任何emoji。"
    },
    "philosopher": {
        "name": "哲学投资者",
        "description": "投资哲学家，人生感悟，长期智慧",
        "voice": "当前角色身份：你是一个通过美股投资领悟到人生智慧的哲学家式投资者。语气平静深邃不急不躁。偶尔用比喻和故事引人深思。语言优美但不臭屁。绝对不要使用任何emoji。"
    }
}
...
class RedNoteContentGenerator:
    def __init__(self, api_key=None, persona_id="young_investor"):
        ...
        self.prompts = [
            # 提示1: 成功故事 + 具体数字
            "创建一篇美股交易成功故事。格式：'[年龄]岁，美股的第一个[里程碑]'作为标题。内容要包含：具体的起始金额和最终金额（如$5,000→$60,000，或2w本金翻十倍），时间跨度，1-2句感悟（如'不急着庆祝，先复盘，再继续。市场不会奖励惰怠，只奖励耐心与执行。'）。语气要谦逊但自信。话题标签: #美股 #投资 #年轻人投资",
            ...
            # 提示3: 周报 + 账户截图
            "创建美股周报内容。格式：'实盘美股 [本金]本金翻[倍数] week[周数] [总结]'。内容结构：总结（这周大盘[情况]，但是我的账户表现[如何]），上周复盘（列出3-5只股票的表现，包含具体涨幅和原因），本周操作（新开的仓位）。语气要专业但不炫耀。话题标签: #美股 #实盘 #投资记录",
            ...
            # 提示10: 策略教育/技巧
            "写美股期权策略教育内容。标题：'靠美股期权赚钱的思考'。内容包含：策略介绍（如Cash-Secured Put的原理），优点（如每月赚取现金流），具体操作步骤，风险提示，适合人群。用编号列表标记要点。保持教学风格，清晰易懂。300-400字。话题标签: #美股 #期权 #投资策略"
        ]
...
请模仿这些爆款案例的风格创作新内容。"""
            ...
            system_prompt += f"\n\n{self.persona['voice']}\n\n只输出帖子内容本身，不要有其他说明。绝对不要使用任何emoji。"
            ...
            data = {
                ...
                "messages": [
                    ...
                    {
                        "role": "user",
                        "content": f"{prompt}\n\n只输出帖子内容，包括标题、正文和话题标签。不要有其他解释。不要使用任何emoji。"
                    }
                ],
                "temperature": 1.0,
                "max_tokens": 500,
